...
# Settings for rbenv
export PATH="$HOME/.rbenv/bin:/usr/pgsql-9.3/bin:$PATH"
eval "$(rbenv init -)"
...
# Bring in custom aliases
if [ -f ~/.userrc ]; then
	. ~/.userrc
fi

. .config/source_this.sh
